...
void create() {
    ::create();
    SetAmbientLight(5);
    SetShort("Dark Passageway");
    SetLong("This is a dark underground passageway. The walls are rough and bare. Above there seems to be another part of the cave but there is no obvious way of walking up there.");
    SetItems(([
    ...
    SetFlyRoom("/domains/amigara/room/midair");
    SetInventory(([
                ]));
    SetClimate("indoors");
