...
int ResetGame(){
    ...
    objects = ({});
    objects+=({ load_object("/domains/campus/room/red_room2") });
    objects+=({ load_object("/domains/campus/room/green_room2") });
    objects+=({ load_object("/domains/campus/room/blue_room2") });

    objects = ({ load_object("/domains/campus/doors/red_door2") });
    objects +=({ load_object("/domains/campus/doors/green_door2") });
    objects +=({ load_object("/domains/campus/doors/blue_door2") });
...
int MontyMagic(string str){
    ...
    load_object("/domains/campus/doors/"+color+"_door2")->SetLocked(0);
    load_object("/domains/campus/doors/"+color+"_door2")->SetClosed(0);
    tell_room(environment(),"A voice from the pedestal says: "
