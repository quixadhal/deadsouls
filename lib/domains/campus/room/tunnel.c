...
static void create() {
    ...
    SetLong("You are in a dark and narrow underground tunnel. The walls are bare rock "+
      ...
      "run along the southern wall, and seem to emit a low hum. To the west you see a false wall "+
      "leading into the basement of the Vitual Campus administrative building. To the "+
      "east, the tunnel continues into darkness.");
    SetItems(([
    ...
    SetExits(([
        "west" : "/domains/campus/room/basement2",
        "east" : "/domains/campus/room/tunnel2"]));
