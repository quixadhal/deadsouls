...
static void create() {
    ...
    SetNightLight(25);
    SetShort("West wall");
    SetDayLong("You are at the top of the west wall. The fortress militia patrol here to surveil the vast western forest, but it's obvious that no serious attack could be made on the fortress from this side. The thirty foot walls and the fifty foot dropoff from the plateau would make any siege impossible. The southwest wall is south of here, and the west wall continues north.");
    ...
    SetExits(([
	"south" : "/domains/fort/room/west_wall_1",
	"north" : "/domains/fort/room/west_wall_3",
      ]));
