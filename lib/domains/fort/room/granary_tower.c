...
static void create() {
    ...
    SetDayLight(30);
    SetNightLight(25);
    SetShort("granary tower");
    SetDayLong("granary tower, day");
    SetNightLong("granary tower, night");
    SetProperties (([
	"no attack":0, 
	"no bump":0, 
	"no steal":0, 
    ...
    AddExit("down", MY_ROOM + "/" +"granary");
    AddExit("north", MY_ROOM + "/" +"west_wall_6");
    AddExit("south", MY_ROOM + "/" +"west_wall_5");
    //funs
    //snuf
}
void init() {
