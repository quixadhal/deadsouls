...
void create() {
    ...
    SetNightLight(15);
    SetShort("Fort Road");
    SetDayLong("This cobblestone road wends its way south toward a town, and north to the main gate of the fortress. The road rises north toward the plateau, where it is level with the fortress.");
    SetItems(([
    ...
    SetExits( ([
	"south" : "/domains/town/room/road2",
	"north" : "/domains/fort/room/f_road3.c",
      ]) );

    SetNightLong("This cobblestone road wends its way south into darkness, and north to the glittering night lights of the fortress. The ground at the sides of the road slopes up sharply, making it impossible to go off the road.");
