...
static void create() {
    ...
    SetLong("You are deep in the orc stronghold. Like the "+
      "rest of the fortress you have seen, this looks hastily "+
      "put together and rather clumsily built, with poor "+
      "maintenance besides. This is some kind of ceremonial "+
      "chamber or temple. Dried blood surrounds a raised "+
