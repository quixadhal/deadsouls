...
void create() {
    ::create();
    set_properties( ([ "light" : 2, "no castle" : 1 ]) );
    set_short( "a deluxe sleeping chamber" );
    set_long( "You have entered one of the deluxe rooms of the Nightmare "
    ...
    set_exits( ([ "leave" : "/domains/Praxis/hall3.c" ]) );
}
