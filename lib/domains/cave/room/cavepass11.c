...
void create() {
    ...
    SetLong("This is a dark underground passageway. The walls are rough and bare. The passageway runs west from here. There is a room to the north.");
    SetItems(([
    ...
    SetClimate("indoors");
    SetExits( ([
                "west" : "/domains/cave/room/cavepass10",
                "north" : "/domains/cave/room/common3.c",
                ]) );
