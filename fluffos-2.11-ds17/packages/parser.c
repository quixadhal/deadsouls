        ...
        *buf++ = '_';
        ...
        case LIV_A_TOKEN:
          ...
          put_obj_value:
             ...
             */
#if 1
//if( matches[match].val.number > MAX_NUM_OBJECTS ){ 
//debug_message("WATCH OUT!: %d",matches[match].val.number);
//debug_message("WATCH OUT!: %d",matches[match].val.number);
//}
#endif
            if (which >= 4) {
                ...
                push_number(0);
            } else if (!loaded_objects) {
                push_number(0);
            } else if (!loaded_objects[matches[match].val.number]) {
                push_number(0);
            } else if (!(loaded_objects[matches[match].val.number]->flags)) {
                push_number(0);
